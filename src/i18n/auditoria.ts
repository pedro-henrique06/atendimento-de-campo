...
export const camposAuditoria: Rotulos = {
  Pt: {
    ...
    'ginecologia.dum': 'Data da última menstruação',
    'ginecologia.gestacoes': 'Gestações',
    'ginecologia.partos': 'Partos',
    'ginecologia.abortos': 'Abortos',
    'ginecologia.gestante': 'Gestante',
    'ginecologia.semanasGestacao': 'Semanas de gestação',
    'ginecologia.metodoContraceptivo': 'Método contraceptivo',
    'ginecologia.ultimoPreventivo': 'Último preventivo',
    'ultrassom.exameSolicitado': 'Exame solicitado',
    'ultrassom.indicacao': 'Indicação do exame',
    'ultrassom.analise': 'Análise',
    'ultrassom.conclusao': 'Conclusão do laudo',
    'ultrassom.desfecho': 'Desfecho da consulta',
    'farmacia.orientacoes': 'Orientação farmacêutica',
    'farmacia.observacoes': 'Observações',
    'farmacia.desfecho': 'Desfecho da consulta',
  ...
  Es: {
    ...
    'ginecologia.dum': 'Fecha de la última menstruación',
    'ginecologia.gestacoes': 'Gestaciones',
    'ginecologia.partos': 'Partos',
    'ginecologia.abortos': 'Abortos',
    'ginecologia.gestante': 'Embarazada',
    'ginecologia.semanasGestacao': 'Semanas de gestación',
    'ginecologia.metodoContraceptivo': 'Método anticonceptivo',
    'ginecologia.ultimoPreventivo': 'Última citología',
    'ultrassom.exameSolicitado': 'Examen solicitado',
    'ultrassom.indicacao': 'Indicación del examen',
    'ultrassom.analise': 'Análisis',
    'ultrassom.conclusao': 'Conclusión del informe',
    'ultrassom.desfecho': 'Desenlace de la consulta',
    'farmacia.orientacoes': 'Orientación farmacéutica',
    'farmacia.observacoes': 'Observaciones',
    'farmacia.desfecho': 'Desenlace de la consulta',
  ...
  En: {
    ...
    'ginecologia.dum': 'Last menstrual period',
    'ginecologia.gestacoes': 'Pregnancies',
    'ginecologia.partos': 'Births',
    'ginecologia.abortos': 'Miscarriages',
    'ginecologia.gestante': 'Pregnant',
    'ginecologia.semanasGestacao': 'Weeks of pregnancy',
    'ginecologia.metodoContraceptivo': 'Contraceptive method',
    'ginecologia.ultimoPreventivo': 'Last cervical screening',
    'ultrassom.exameSolicitado': 'Requested scan',
    'ultrassom.indicacao': 'Scan indication',
    'ultrassom.analise': 'Findings',
    'ultrassom.conclusao': 'Report conclusion',
    'ultrassom.desfecho': 'Consultation outcome',
    'farmacia.orientacoes': 'Pharmacist advice',
    'farmacia.observacoes': 'Notes',
    'farmacia.desfecho': 'Consultation outcome',
...
const TABELA_POR_CAMPO: Record<string, Record<Idioma, Record<string, string>>> = {
  ...
  'ultrassom.desfecho': desfechos,
  'farmacia.desfecho': desfechos,
};
